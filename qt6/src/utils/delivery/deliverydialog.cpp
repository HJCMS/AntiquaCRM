...
DeliveryDialog::DeliveryDialog(QWidget *parent) : QDialog{parent} {
  ...
  ac_create->setIcon(AntiquaCRM::antiquaIcon("action-add"));
...
void DeliveryDialog::initItemsTreeView() {
  m_list->clear();
...
void DeliveryDialog::messanger(const QString &msg) {
  m_statusBar->showMessage(msg, (1000 * 5));
}

void DeliveryDialog::deleteDeliveryPackage(const QJsonObject &obj) {
...
void DeliveryDialog::keyPressEvent(QKeyEvent *e) {
...
bool DeliveryDialog::event(QEvent *e) {
...
void DeliveryDialog::saveCurrent() {
...
void DeliveryDialog::queryDeliverServices(int id) {
...
void DeliveryDialog::queryServicePackage(int id, const QJsonObject &obj) {
