...
SellerImportRepair::SellerImportRepair(const QString &provider,
  ...
  m_navbar = new ImportRepairNavBar(this);
...
void SellerImportRepair::keyPressEvent(QKeyEvent *e) {
...
bool SellerImportRepair::event(QEvent *e) {
