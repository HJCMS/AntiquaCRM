...
#ifndef ANTIQUACRM_PROVIDERS_LOADER_H
#define ANTIQUACRM_PROVIDERS_LOADER_H
...
public:
   ...
   */
  explicit ProvidersLoader(QObject *parent = nullptr);
   ...
   *
   * @sa @ref getInterface, @ref AntiquaCRM::ProviderInterface
   * @param parent - parent object
   */
  const QList<AntiquaCRM::ProviderInterface *> interfaces(QObject *parent);
};

} // namespace AntiquaCRM

#endif // ANTIQUACRM_PROVIDERS_LOADER_H
