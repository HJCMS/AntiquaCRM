...
DateTimeInfo::DateTimeInfo(QWidget* parent) : AntiquaCRM::AInputWidget{parent} {
...
const QVariant DateTimeInfo::getValue() {
...
const QString DateTimeInfo::statusHints() {
  return popUpHints();
}
