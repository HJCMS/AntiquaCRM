...
#ifndef ANTIQUACRM_WIDGETS_SELECTTARGETS_H
#define ANTIQUACRM_WIDGETS_SELECTTARGETS_H
...
public:
   ...
   */
  explicit SelectTargets(QWidget *parent = nullptr);
...
#endif // ANTIQUACRM_WIDGETS_SELECTTARGETS_H
