...
void SelectVAT::initData() {
  ...
  int _c = 1;
  m_edit->insertItem(_c++, AntiquaCRM::antiquaIcon("view-investment"), tr("Without sales tax"),
...
void SelectVAT::setInputToolTip(const QString& tip) {
...
const QMetaType SelectVAT::getType() const {
...
const QString SelectVAT::popUpHints() {
  return tr("a valid VAT is required.");
}

const QString SelectVAT::statusHints() {
  return popUpHints();
}
