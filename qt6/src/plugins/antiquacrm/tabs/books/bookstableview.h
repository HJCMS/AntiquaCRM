...
#ifndef ANTIQUACRM_PLUGIN_BOOKSTABLEVIEW_H
...
class ANTIQUACRM_BOOKS_PLUGIN BooksTableView final : public AntiquaCRM::TableView {
  Q_OBJECT
...
#endif // ANTIQUACRM_PLUGIN_BOOKSTABLEVIEW_H
