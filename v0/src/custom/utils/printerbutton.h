...
#ifndef PRINTERBUTTON_UTILS_H
#define PRINTERBUTTON_UTILS_H
...
class PrinterButton : public QPushButton {
  ...
  Q_PROPERTY(Buttons buttons READ getButtons WRITE setButtons NOTIFY buttonsChanged)
