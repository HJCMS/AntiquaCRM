    ...
    : SettingsWidget{parent}
{
    ...
    QSpacerItem* sp = new QSpacerItem(10,10,QSizePolicy::Maximum,QSizePolicy::Minimum);
    ...
    lt_hostname->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
    ...
    psql_hostname->setToolTip(tr("In your Network a DNS Server exists. Then use a Fully Qualified Hostname (FQDN) to connect the PostgreSQL Server. If Not, it's better to insert the IP Address in here. Warning: SSL Certification based Connection need a Hostname for translate the <b>CommonName</b> Attribute."));
    ...
    QSpacerItem *horizontalSpacer = new QSpacerItem(100, 10, QSizePolicy::Expanding, QSizePolicy::Minimum);
    ...
    lt_dbname->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
    ...
    lt_dbuser->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
    ...
    lt_password->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
    ...
    lb7->setText(tr("If you using SSL/TLS or SSL Client certificates. Make sure, you have also the CA-Root Certificate in your System Issuer cache."));
    verticalLayout->addWidget(lb7);

    mainLayout->addWidget(psql_ssl);

    QSpacerItem* vsp = new QSpacerItem(50,20,QSizePolicy::Minimum,QSizePolicy::Expanding);
...
/**
 * @brief PostgreSqlSettings::updateConfigSets
 * @param d  QSettings::group
 * @todo Passwort entschlüsseln
 */
void PostgreSqlSettings::updateConfigSets(const QHash<QString,QVariant> &d)
{
    ...
    QByteArray pw = QByteArray::fromBase64(d.value("password").toByteArray(), QByteArray::Base64UrlEncoding);
    QString pass(pw);
...
/**
 * @brief PostgreSqlSettings::getSectionConfig
...
const QHash<QString,QVariant> & PostgreSqlSettings::getSectionConfig()
{
    ...
    QByteArray pw = psql_password->text().toLocal8Bit().toBase64(QByteArray::Base64Encoding);
